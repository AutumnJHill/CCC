...
<body>
    ...
    <div class="wish outer">
     	<div align="center" style="padding-bottom:;">
			<div class="titleimage"; align="center" style="position: relative;">
		        <img src="resources/myPage/image/mainchar.jpg" style="width:900px;height:380px;align-center;">
		        <h3 class="imagetext" style="font-size:34px;font-weight:bold;color:white;position:absolute;top:63%;left: 45%;">WishList &nbsp;</h3>  
	     	</div>
     	</div>
