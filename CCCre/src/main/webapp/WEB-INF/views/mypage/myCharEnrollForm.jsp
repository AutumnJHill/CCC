		...
		<form action="insert.mychar" id="enroll-form" method="post" enctype="multipart/form-data">
			<table align="center">
				...
				<tr>
					...
					<td colspan="3"><input type="text" style="margin-left:80px;" name="characterName"></td>
				</tr>
				<tr>
					<th>캐릭터설명</th>
					<td colspan="3"><textarea name="characterContent" style="resize: none;" cols="50" rows="10" required></textarea></td>
				</tr>
				<tr>
				    <th width="150px;">대표이미지  첨부</th>	
					<td colspan="3">
					  <img id="titleImg" width="180" height="170" style="margin-left: 120px;">
					</td>			
				</tr>
				<tr>
				<th>상세이미지</th>
